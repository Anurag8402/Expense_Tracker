...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
 ...
 <c:if test="${not empty loginUser}">
 	    <li class="nav-item">
          <a class="nav-link active" href="add_expense.jsp"><i class="fa-regular fa-square-plus"></i> add_expense</a>
        </li>
      
        <li class="nav-item">
          <a class="nav-link active" href="view_expense.jsp" tabindex="-1"><i class="fa-solid fa-list-ul"></i> view_expense</a>
        </li>
